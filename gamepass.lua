...
local function corner(parent, radius)
    -- Border radius removed for sharper, modern look
    return nil
end
...
panel.BackgroundColor3 = Color3.fromRGB(15, 8, 28)
panel.BorderSizePixel = 0
panel.Parent = screenGui
stroke(panel, Color3.fromRGB(140, 70, 220), 2)
...
if not isMobile then
    ...
    stroke(resizeHandle, Color3.fromRGB(200, 120, 255), 2)
...
titleBar.BackgroundColor3 = Color3.fromRGB(25, 10, 50)
titleBar.BorderSizePixel = 0
titleBar.Parent = panel
stroke(titleBar, Color3.fromRGB(140, 70, 220), 1)

local titleFill = Instance.new("Frame")
titleFill.Size = UDim2.new(1, 0, 0, 18)
titleFill.Position = UDim2.new(0, 0, 1, -18)
titleFill.BackgroundColor3 = Color3.fromRGB(25, 10, 50)
...
clearBtn.BackgroundColor3 = Color3.fromRGB(80, 30, 80)
clearBtn.Text = "X Clear"
clearBtn.TextColor3 = Color3.fromRGB(255, 100, 150)
clearBtn.TextSize = 11 * fontSizeScale
clearBtn.Font = Enum.Font.GothamBold
clearBtn.BorderSizePixel = 0
clearBtn.ZIndex = titleBar.ZIndex + 3
clearBtn.Parent = titleBar
stroke(clearBtn, Color3.fromRGB(200, 80, 150), 1.5)

clearBtn.MouseEnter:Connect(function()
    clearBtn.BackgroundColor3 = Color3.fromRGB(70, 30, 60)
end)
clearBtn.MouseLeave:Connect(function()
    clearBtn.BackgroundColor3 = Color3.fromRGB(50, 20, 40)
end)
...
logArea.ScrollBarImageColor3 = Color3.fromRGB(100, 60, 160)
...
footer.BackgroundColor3 = Color3.fromRGB(30, 15, 55)
...
footerFill.BackgroundColor3 = Color3.fromRGB(30, 15, 55)
...
countLabel.TextColor3 = Color3.fromRGB(180, 150, 220)
...
settingsBtn.BackgroundColor3 = Color3.fromRGB(40, 20, 60)
settingsBtn.Text = "SET"
settingsBtn.TextColor3 = Color3.fromRGB(190, 150, 240)
...
stroke(settingsBtn, Color3.fromRGB(120, 80, 180), 1)
...
stopAllBtn.BackgroundColor3 = Color3.fromRGB(60, 20, 50)
stopAllBtn.Text = "Stop All"
stopAllBtn.TextColor3 = Color3.fromRGB(220, 120, 180)
...
corner(stopAllBtn, 7)
stroke(stopAllBtn, Color3.fromRGB(140, 80, 140), 1)

local closeBtn = Instance.new("TextButton")
closeBtn.Size = UDim2.new(0, 26, 0, 26)
closeBtn.Position = UDim2.new(1, -6, 0, -6)
closeBtn.AnchorPoint = Vector2.new(1, 0)
closeBtn.BackgroundColor3 = Color3.fromRGB(60, 20, 50)
closeBtn.Text = "X"
closeBtn.TextColor3 = Color3.fromRGB(220, 120, 180)
...
local function toggleSettings()
    if settingsWindow then
        ...
        closeSettingsBtn.BackgroundColor3 = Color3.fromRGB(60, 20, 50)
        closeSettingsBtn.Text = "X"
        closeSettingsBtn.TextColor3 = Color3.fromRGB(220, 120, 180)
        ...
        speedLabel.TextColor3 = Color3.fromRGB(190, 150, 240)
        ...
        speedBox.BackgroundColor3 = Color3.fromRGB(30, 15, 55)
        ...
        speedHint.TextColor3 = Color3.fromRGB(150, 120, 200)
        ...
        saveBtn.BackgroundColor3 = Color3.fromRGB(40, 20, 60)
        saveBtn.Text = "Save"
        saveBtn.TextColor3 = Color3.fromRGB(180, 100, 255)
        saveBtn.TextSize = 12
        ...
        corner(saveBtn, 7)
        stroke(saveBtn, Color3.fromRGB(120, 80, 180), 1)
        ...
        saveBtn.MouseButton1Click:Connect(function()
            ...
            if newSpeed then
                ...
                if newSpeed >= 1 and newSpeed <= 10000 then
                    ...
                    savedMsg.Text = "Saved!"
                    savedMsg.TextColor3 = Color3.fromRGB(180, 100, 255)
                    ...
                    speedBox.BackgroundColor3 = Color3.fromRGB(80, 30, 60)
                    task.wait(0.5)
                    speedBox.BackgroundColor3 = Color3.fromRGB(30, 15, 55)
                end
            else
    ...
    if screenGui.Enabled then
        ...
        if isMobile then
            if not reopenButton or not reopenButton.Parent then
                ...
                reopenButton.BackgroundColor3 = Color3.fromRGB(40, 20, 60)
                reopenButton.Text = "S"
                reopenButton.TextColor3 = Color3.fromRGB(220, 180, 255)
                ...
                stroke(reopenButton, Color3.fromRGB(120, 80, 180), 1.5)
...
local function addLog(label, id, signalType)
    ...
    entry.BackgroundColor3 = Color3.fromRGB(30, 15, 55)
    entry.BorderSizePixel = 0
    entry.LayoutOrder = -(eventCount)
    entry.Parent = logArea
    corner(entry, 10)
    stroke(entry, Color3.fromRGB(90, 60, 140), 1)
    ...
    lbl.TextColor3 = Color3.fromRGB(190, 150, 240)
    ...
    idEl.TextColor3 = Color3.fromRGB(220, 200, 255)
    ...
    copyBtn.MouseEnter:Connect(function()
        copyBtn.TextColor3 = Color3.fromRGB(220, 180, 255)
        copyBtn.BackgroundColor3 = Color3.fromRGB(50, 30, 80)
    end)
    ...
    local function startAuto()
        ...
        autoBtn.TextColor3 = Color3.fromRGB(255, 150, 220)
    ...
    local function onRunRelease()
        ...
        elseif heldDuration < 3 then
            fireFakeSignal(signalType, id)
            runBtn.Text = "Sent!"
            runBtn.TextColor3 = Color3.fromRGB(180, 100, 255)
            task.wait(1.5)
            if runBtn.Parent then
                runBtn.Text = "Run"
                runBtn.TextColor3 = Color3.fromRGB(190, 150, 240)
    ...
    runBtn.MouseEnter:Connect(function()
        if not isSpamming then
            runBtn.TextColor3 = Color3.fromRGB(180, 100, 255)
            runBtn.BackgroundColor3 = Color3.fromRGB(50, 25, 75)
        end
    end)
